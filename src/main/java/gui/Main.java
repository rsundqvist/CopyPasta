    ...
    if (isRunning) {
      ...
      Alert alert =
          new Alert(
              ...
              "Another instance of CopyPasta appears to be running. This is not recommended as it may cause data loss. If the program was not shut down properly, this message may be shown erroneously.",
