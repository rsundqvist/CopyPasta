...
public abstract class Settings {
    ...
    private static Map<String, String[]> createAbout() {
        ...
        about.put(
                ...
                new String[] {
                    "Workspace Location", // Display name
    ...
    public static void loadFromProperties() {
        try {
            USE_NATIVE_TXT_EDITOR =
                    Boolean.parseBoolean((String) properties.get(use_native_txt_editor));
    ...
    public static boolean getRunningFile() {
        return Boolean.parseBoolean(
                IO.getFileAsString(Tools.IS_RUNNING_FILE).replaceAll("\\s+", ""));
    }
}
