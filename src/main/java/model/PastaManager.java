...
public class PastaManager {
  ...
  /**
   * Update the filtering mode for the manager. Will call {@link #updateFilteredList()} if the mode
   * changed.
   *
   * @param anyTag The new filtering mode. A {@code true} value implies union, {@code false} implies
   *     intersect.
   */
